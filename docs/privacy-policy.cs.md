...
- Na registrační stránce zpřístupněte oba dokumenty před odesláním formuláře a evidujte přijetí verze podmínek. Odkaz na informace o zpracování údajů neprezentujte jako „souhlas s GDPR“.
- Umístěte trvalé odkazy na oba dokumenty do patičky nebo jiného snadno dostupného místa. Při současném použití pouze technické cookie není nutná cookie lišta.
