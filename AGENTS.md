...
<!-- NOTE: Backend requests emit JSON logs with `x-request-id`; `/health` checks PostgreSQL and `/metrics` feeds the provisioned Grafana dashboard at :3001. Alloy ships all Docker logs to Loki. -->
